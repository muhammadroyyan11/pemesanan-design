		<div class="row small-spacing">
			<div class="col-lg-6 col-xs-12">
				<div class="box-content card">
					...
					if ($value1->kategori != 3) {
						$jumlah_harga = ($ket_pembelian->jumlah_kertas  + $ket_produk->harga) + substr($value2->no_telpon, -3);
					} elseif ($value1->kategori == 3) {
						...
						<div class="card-content">
							<div class="form-group">
								<?php if (count($cek_komentar->result()) > 0) {
									...
									if ($ada == 0) { ?>
										<center><b>
												<h4>Pembeli Belum Memberikan Komentar</h4>
											</b></center>
									<?php
									} else { ?>
										<center><b><i>
													<h4>"<?= $komentarnya ?>"</h4></b></i></center>
									<?php
									}
								} else { ?>
									<center><b>
			...
			<div class="col-lg-6 col-xs-12">
						...
						<div class="form-horizontal">
							...
							<?php if ($value1->kategori == 3) : ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->tanggal != '') {
																										echo $ket_pembelian->tanggal;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->waktu != '') {
																										echo $ket_pembelian->waktu;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea class="form-control" id="inp-type-5" placeholder="Write your meassage" disabled style="resize: none;"><?php if ($ket_pembelian->alamat_data != '') {
																																							echo $ket_pembelian->alamat_data;
																																						} else {
																																							echo "-";
																																						} ?></textarea>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->no_telpon != '') {
																										echo $ket_pembelian->no_telpon;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->media_sosial != '') {
																										echo $ket_pembelian->media_sosial;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea class="form-control" id="inp-type-5" placeholder="Write your meassage" disabled style="resize: none;"><?php if ($ket_pembelian->penambahan_ket != '') {
																																							echo $ket_pembelian->penambahan_ket;
																																						} else {
																																							echo "-";
																																						} ?></textarea>
									</div>
							...
							<?php elseif ($value1->kategori == 1 and $ket_produk->undangan == 2) : ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_nama_pertama != '') {
																										echo $ket_pembelian->ket_nama_pertama;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Keterangan</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_nama_kedua != '') {
																										echo $ket_pembelian->ket_nama_kedua;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Keterangan</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_ortu_pertama != '') {
																										echo $ket_pembelian->ket_ortu_pertama;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Keterangan</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_ortu_kedua != '') {
																										echo $ket_pembelian->ket_ortu_kedua;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->nama_keluarga_mengundang != '') {
																										echo $ket_pembelian->nama_keluarga_mengundang;
																									} else {
																										echo "-";
																									} ?>">
									</div>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Keterangan</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_keluarga_mengundang != '') {
																										echo $ket_pembelian->ket_keluarga_mengundang;
																									} else {
																										echo "-";
																									} ?>">
									</div>
							...
							<?php elseif ($value1->kategori == 1 and $ket_produk->undangan == 1) : ?>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Keterangan</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_ortu != '') {
																										echo $ket_pembelian->ket_ortu;
																									} else {
																										echo "-";
																									} ?>">
									</div>
							...
							<?php elseif ($value1->kategori == 2) : ?>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">Alamat</label>
									<div class="col-sm-9">
										<input type="email" class="form-control" disabled="" value="<?php if ($ket_pembelian->alamat != '') {
																										echo $ket_pembelian->alamat;
																									} else {
																										echo "-";
																									} ?>">
									</div>
				...
				<?php
				if ($bukti_pelunasan->pembayaran == 'DP') { ?>
					<?php if ($bukti_pelunasan->bukti_pelunasan != NUll || $bukti_pelunasan->bukti_pelunasan != '') { ?>
						<div class="box-content card">
							<h4 class="box-title">Bukti Pembayaran Pelunasan</h4>
							<div class="card-content">
								<div class="form-horizontal">
									<div class="form-group">
									...
									<div class="form-group">
										<center>
											<a href="<?= base_url('admin/proses_pembuatan/konfirmasi/' . $this->uri->segment(3)) ?>"><button type="button" class="btn btn-info waves-effect waves-light">Konfirmasi Pelunasan</button></a>&nbsp
										</center>
									</div>
								</div>
							</div>
					...
					<?php } else { ?>
						<div class="box-content card">
							<h4 class="box-title">Pembeli Belum Mengirim Bukti Pelunasan</h4>
