				...
				<div class="col-lg-6 col-xs-12">
					<div class="box-content card">
						...
						<div class="card-content">
							<div class="form-horizontal">
								<div class="form-group">
									<center><img src="<?= base_url($value3->foto_transaksi) ?>" width="50%"></center>
								</div>
								...
								<?php if ($value1->kategori != 3) : ?>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<!-- <input type="email" class="form-control" id="inputEmail3" value="Rp. <?= number_format(($ket_pembelian->jenis_kertas + $ket_produk->harga)) ?>" disabled=""> -->
											<input type="email" class="form-control" id="inputEmail3" value="Rp. <?= number_format(($ket_produk->harga * $ket_pembelian->jumlah_kertas)) ?>" disabled="">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="email" class="form-control" id="inputEmail3" value="Rp. <?= number_format(($ket_produk->harga * $ket_pembelian->jumlah_kertas) + substr($value2->no_telpon, -3)) ?>" disabled="">
										</div>
									</div>
								<?php endif ?>
								<?php if ($value1->kategori == 3) : ?>
