	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				...
				<li <?php if ($this->uri->segment(2) == 'Chat Pembeli') { echo 'class="current"'; } ?>>
					<a class="waves-effect" href="<?=base_url()?>admin/chat_index"><i class="menu-icon fa fa-comments-o"></i><span>Chat Pembeli</a>
