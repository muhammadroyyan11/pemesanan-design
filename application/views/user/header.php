          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li <?php if ($this->uri->segment(2) == 'chat') { echo 'class="active"'; } ?>><a href="<?=base_url()?>user/chat">Chat Admin</a></li>
                <!-- <li <?php if ($this->uri->segment(2) == 'pengembalian') { echo 'class="active"'; } ?>><a href="<?=base_url()?>user/pengembalian">Pengembalian</a></li> -->
               
                <li <?php if ($this->uri->segment(2) == 'user') { echo 'class="active"'; } ?>><a href="<?=base_url()?>user/user">Profil</a></li>
