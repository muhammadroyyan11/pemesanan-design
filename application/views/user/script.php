    ...
    <?php if ($value->kategori != 3) : ?>
      <script type="text/javascript">
        ...
        function my_function() {
          ...
          // var harga = (parseFloat(jenis_kertas) + parseFloat(<?= $ket->harga ?>))  * parseFloat(jumlah_kertas);
          // var harga = (parseFloat(jenis_kertas) * parseFloat(jumlah_kertas)) + parseFloat(<?= $ket->harga ?>);
          var harga = (parseFloat(<?= $ket->harga ?>) * parseFloat(jumlah_kertas));
          // console.log(numberWithCommas(harga)); 
          $('#jumlah_harga').val("Rp . " + numberWithCommas(harga))
    ...
    <?php if ($kategori == 'Undangan Nikah') : ?>
      <script type="text/javascript">
        function proses() {
          ...
          // } else 
          if (jumlah_kertas == '' || jumlah_kertas == null) {
          ...
          // }
          ...
          } else if (pembayaran == '' || pembayaran == null) {
            // console.log(alamat);
            toastr.options = {
              "closeButton": true,
              "debug": false,
            ...
            toastr.error("<b>Error</b><br>Pembayaran Harus Dipilih");
      ...
      <script type="text/javascript">
        function proses() {
          ...
          if (jumlah_kertas == '' || jumlah_kertas == null) {
            ...
            toastr.error("<b>Error</b><br>Jenis Pembayaran Harus Dipilih");
            $('select[name="pembayaran"]').focus();
      ...
      <script type="text/javascript">
        function proses() {
          ...
          // }
            ...
            toastr.error("<b>Error</b><br>Jenis Pembayaran Harus Diisi");
            $('select[name="pembayaran"]').focus();
          } else if (deadline == '' || deadline == null) {
            // console.log(alamat);
            toastr.options = {
  ...
  <?php elseif ($this->uri->segment(2) == 'pesanan') : ?>
    ...
    <script type="text/javascript">
      function upload_pelunasan() {
        var file_data = $('#imagepelunasan').prop('files')[0];
        var form_data = new FormData();
        form_data.append('file', file_data);
        var file = document.getElementById('imagepelunasan').files[0];
        ...
        if (document.getElementById('imagepelunasan').value == "") {
          toastr.options = {
            "closeButton": true,
            "debug": false,
            "progressBar": true,
          ...
          document.getElementById('imagepelunasan').focus();
          ...
          toastr.error("Size Foto Maksimal 1.5 Mb");
          document.getElementById('imagepelunasan').focus();
          ...
          $.ajax({
            ...
            processData: false,
            type: "post",
            url: "<?= base_url() ?>user/pesanan/upload_foto_pelunasan/<?= $this->uri->segment(4) ?>",
            data: form_data,
        ...
        <script type="text/javascript">
          ...
          function my_function() {
            ...
            if (jenis_kertas == null || jenis_kertas == '') {
              ...
              var harga = (parseFloat(jenis_kertas) * parseFloat(jumlah_kertas)) + <?php if ($beli_desain == 0) {
                                                                                      echo $ket->harga;
                                                                                    } elseif ($beli_desain == 1) {
                                                                                      echo 0;
                                                                                    } ?>;
              // console.log(numberWithCommas(harga)); 
              $('#jumlah_harga').val("Rp . " + numberWithCommas(harga))
        ...
        <script type="text/javascript">
          ...
          function my_function() {
            ...
            if (panjang == '' || panjang == null) {
              ...
              // var jumlah_panjang = parseFloat(panjang) * 12500;
              // var jumlah_lebar = parseFloat(lebar) * 12500;
              var harga = panjang * lebar * 12500 * jumlah_kertas + <?php if ($beli_desain == 0) {
                                                                      echo $ket->harga;
                                                                    } elseif ($beli_desain == 1) {
                                                                      echo 0;
                                                                    } ?>;
