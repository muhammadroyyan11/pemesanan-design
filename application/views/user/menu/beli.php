            ...
            <div class="col-md-12 col-lg-12">
              <div class="h-entry">
                <center><img src="<?= base_url($ket->img) ?>" alt="Image" class="img-fluid">
                  ...
                  <div class="meta mb-4"><span class="mx-2"></span><b><?= $kategori ?></b> / Upload &bullet; <?= $value->tanggal_upload ?><span class="mx-2">&bullet;</span> <br><b>Harga Per Desain</b> : Rp. <?= number_format($ket->harga) ?></div>
                </center>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <form class="col-md-8 mb-5" id="ini_formnya" method="post">
            <div class="p-4 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black">Pilih Pembayaran</label>
