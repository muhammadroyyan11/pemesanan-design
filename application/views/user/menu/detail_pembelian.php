          ...
          <form class="col-md-8 mb-5" id="ini_formnya" method="post">
            <div class="p-4 bg-white">
              ...
              <div id="myDIV" style="display: none;">
                ...
                <div class="row form-group">
                  <div class="col-md-12">
                    <label class="text-black" for="email">Pembayaran</label>
                    <input type="text" class="form-control" value="<?= $ket_pembelian->pembayaran ?>" disabled>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div id="myDIV1" style="display: none;">
                ...
                <?php
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-md-6">
                      <label class="text-black" for="lname">Keterangan</label>
                      <input type="text" title="Keterangan Anak" class="form-control" value="<?php if ($ket_pembelian->ket_anak != '') {
                                                                                                echo $ket_pembelian->ket_anak;
                                                                                              } else {
                                                                                                echo "-";
                                                                                              } ?>" disabled>
                    </div>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-md-6">
                      <label class="text-black" for="lname">Keterangan</label>
                      <input type="text" title="Keterangan Untuk Orang Tua/" class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_ortu != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <label class="text-black" for="fname">Nama Keluarga Yang Mengundang</label>
                      <input type="text" title="Nama Keluarga Mengundang" class="form-control" disabled="" value="<?php if ($ket_pembelian->nama_keluarga_mengundang != '') {
                    ...
                    <div class="col-md-6">
                      <label class="text-black" for="lname">Keterangan</label>
                      <input type="text" title="Keterangan Keluarga Mengundang " class="form-control" disabled="" value="<?php if ($ket_pembelian->ket_keluarga_mengundang != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="message">Penambahan Keterangan</label>
                      <textarea id="message" cols="30" rows="7" class="form-control" title="Keterangan yang ingin ditambah pada desain" disabled><?php if ($ket_pembelian->penambahan_ket != '') {
                ...
                <?php
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      ...
                      <input type="text" title="No Telepon" class="form-control" disabled="" value="<?php if ($ket_pembelian->no_telpon != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      ...
                      <input type="text" title="Pekerjaan" class="form-control" disabled="" value="<?php if ($ket_pembelian->pekerjaan != '') {
                                                                                                      echo $ket_pembelian->pekerjaan;
                                                                                                    } else {
                                                                                                      echo "-";
                                                                                                    } ?>">
                    </div>
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      ...
                      <input type="text" title="Alamat" class="form-control" disabled="" value="<?php if ($ket_pembelian->alamat_data != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      ...
                      <input type="text" title="Media Sosial" class="form-control" disabled="" value="<?php if ($ket_pembelian->media_sosial != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="message">Penambahan Keterangan</label>
                      <textarea cols="30" rows="7" class="form-control" title="Keterangan yang ingin ditambah pada desain" disabled><?php if ($ket_pembelian->penambahan_ket != '') {
                                                                                                                                      echo $ket_pembelian->penambahan_ket;
                                                                                                                                    } else {
                                                                                                                                      echo "-";
                                                                                                                                    } ?></textarea>
                ...
                <?php
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">Tanggal</label>
                      <input type="date" title="Tanggal" class="form-control" disabled="" value="<?php if ($ket_pembelian->tanggal != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      ...
                      <input type="time" title="Waktu" class="form-control" disabled="" value="<?php if ($ket_pembelian->waktu != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="email">Alamat</label>
                      <input type="text" title="Alamat" class="form-control" disabled="" value="<?php if ($ket_pembelian->alamat != '') {
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      ...
                      <input type="text" title="Email / Media Sosial" class="form-control" disabled="" value="<?php if ($ket_pembelian->media_sosial != '') {
                                                                                                                echo $ket_pembelian->media_sosial;
                                                                                                              } else {
                                                                                                                echo "-";
                                                                                                              } ?>">
                  ...
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label class="text-black" for="message">Penambahan Keterangan</label>
                      <textarea cols="30" rows="7" class="form-control" placeholder="Keterangan Yang Ingin Ditambah Pada Desain" title="Keterangan yang ingin ditambah pada desain" disabled><?php if ($ket_pembelian->penambahan_ket != '') {
                                                                                                                                                                                                echo $ket_pembelian->penambahan_ket;
                                                                                                                                                                                              } else {
                                                                                                                                                                                                echo "-";
                                                                                                                                                                                              } ?></textarea>
