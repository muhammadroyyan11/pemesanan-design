          ...
          <div class="col-md-7">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <?php endif ?>
                <?php if ($value1->kategori != 3) : ?>
                  <input type="Text" class="form-control" value="Rp. <?= number_format(($ket_produk->harga * $ket_pembelian->jumlah_kertas)) ?> / <?= $ket_pembelian->jumlah_kertas ?> pcs" disabled="">
                <?php endif ?>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-12">
                ...
                <?php endif ?>  -->
                <?php if ($value1->kategori != 3) : ?>
                  <input type="Text" class="form-control" value="Rp. <?= number_format(($ket_produk->harga * $ket_pembelian->jumlah_kertas) + $ket_produk->harga + substr($data_pembeli['no_telpon'], -3)) ?>" disabled="">
                <?php endif ?>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label class="text-black">Jenis Pembayaran</label>
                <input type="text" class="form-control" value="<?= $value->pembayaran ?>" disabled="">
                <?php
                if ($value->pembayaran == 'DP') {
                  if ($value->id_transaksi < 4) { ?>
                    <small style="color: red;">*Harap Upload DP Pembayaran</small>
                  <?php } ?>
                <?php  }
                ?>
              </div>
            ...
            <form method="post" id="ini_formnya">
              ...
              if (is_dir($dir) === true) { ?>
                ...
                <div class="row form-group" <?php if ($value->id_transaksi >= 2) : ?> style="display: none" <?php endif ?>>
                  <div class="col-md-12">
                    ...
                    <input type="radio" name="foto_pilih" value="tetap" style="display: inline;" checked="" onclick="klik_foto(1)"><label class="text-black" for="email">Pakai Foto Ini</label> &nbsp &nbsp
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black">Pembayaran</label>
                  <input type="text" class="form-control" value="<?= $value->pembayaran ?>" disabled="">
                </div>
              </div>
              <br><br>
            ...
            <div class="col-md-5">
              ...
              <div class="p-4 mb-3 bg-white">
                ...
                <?php if ($value3->no == 1) : ?>
                  ...
                  <p style="text-align: justify;">Diharap melakukan transaksi pemesanan paling lambat 24 jam setelah melakukan pemesanan. Dibawah merupakan rekening bank kami untuk transaksi pembayaran. Jika ada ketidaksamaan pada <b>Nama Rekening</b>, maka jangan melakukan transaksi pengiriman, Terima Kasih. <br>
                    <hr>
                  <p style="text-align: justify;"><b>Penting</b> : Saat melakukan transaksi harus disesuaikan dengan pembayaran yang telah tertera disana, jika pembeli membayar kurang dari apa yang harus dibayar pesanan tidak akan diproses dan menunggu hingga pembeli membayar sisa dari apa yang harus dibayar. Sedangkan pembeli yang membayar melebihi apa yang seharusnya dibayar, kami tidak akan mengembalikan pembayaran yang lebih tersebut. Terima Kasih <br>
                    ...
                    <?php foreach ($rekening->result() as $key77 => $value77) : ?>
                      ...
                      <b>Nomor Rekening: <?= $value77->nomor_bank ?></b><br>
                      <hr>
                    <?php endforeach ?>
                    ...
                    <i>Terima Kasih telah berbelanja di Website kami</i>
                  </p>
                <?php endif ?>
              ...
              ?>
                <div class="p-4 mb-3 bg-white">
                  ...
                  <?php
                  if ($value4->foto_transaksi != '' || $value4->foto_transaksi != NULL) { ?>
              ...
              <div class="p-4 mb-3 bg-white">
                ...
                <?php if ($value3->no == 1) : ?>
                  ...
                  <?php if ($value->pembayaran == 'DP') { ?>
                    <h2 class="h4 text-black mb-3">Upload Bukti DP Pembayaran</h2>
                  <?php } else { ?>
                    <h2 class="h4 text-black mb-3">Upload Bukti Pembayaran</h2>
                  <?php } ?>
                <?php endif ?>
          ...
          <?php if ($value->id_transaksi >= 4) : ?>
            <div class="col-md-5">
              <div class="p-4 mb-3 bg-white">
                ...
                <?php
                if ($value->pembayaran == 'DP' && $value->id_transaksi != 4) {
                  if ($value->bukti_pelunasan == NULL || $value->bukti_pelunasan == '') { ?>
                    <p style="text-align: justify;">Harap melakukan pelunasan sebelum melihat hasil Foto Desain Yang Telah Dibuat Oleh Kami<br><br>
                    <h2 class="h4 text-black mb-3">Upload Bukti Pelunasan</h2>
                    <div class="col-md-12">
                      ...
                      <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <input type="file" name="foto_upload" id="imagepelunasan" onchange="previewImage();" class="form-control">
                          <input type="hidden" name="id_trx" id="id_trx" value="<?= $value->no ?>" class="form-control">
                        </div>
                      </form>

                      <div class="form-group" style="text-align: center;">
                        <button type="submit" class="btn btn-primary btn-md text-white" onclick="upload_pelunasan()">Upload Bukti Pelunasan</button>
                      </div>
                    <?php  }
                    ?>
                    <!-- disini  -->
