            ...
            <form  method="post" id="ini_formnya">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <select class="form-control" name="pembayaran" required="" <?php if ($value->id_transaksi >= 2): ?> disabled="" <?php endif ?>>
                    <option value="" disabled="">-Pilih Jenis Pembayaran</option>
                    <option value="3" <?php if ($value->pembayaran == 'DP'): ?>selected=""<?php endif ?>> DP</option>
                    <option value="3" <?php if ($value->pembayaran == 'Lunas'): ?>selected=""<?php endif ?>> Lunas</option>
                  </select>
                </div>
              </div>
